# AGENTS.md — gha-indie-worker/gha-indie-worker-mcp-server.rs
...
- GitHub org: [`gha-indie-worker`](https://github.com/gha-indie-worker)
- Repository: [`gha-indie-worker/gha-indie-worker-mcp-server.rs`](https://github.com/gha-indie-worker/gha-indie-worker-mcp-server.rs)
- Local checkout: `~/codes/gha-indie-worker/gha-indie-worker-mcp-server.rs`
...
- Sibling test org: `github.com/gha-indie-worker-test` (external/e2e coverage and extra GHA minutes)
...
- Package / service name: `gha-indie-worker-mcp-server`
